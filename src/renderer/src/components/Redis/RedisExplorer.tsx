...
export default function RedisExplorer({ tab }: { tab: Tab }) {
  ...
  const loadKeys = async (id: string, pat: string) => {
    ...
    try {
      ...
      setKeys((result as string[]).sort().map(k => ({ key: k })))
    } catch (e: any) {
      setError(e.message)
    } finally {
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <input
                    ...
                    onKeyDown={e => { if (e.key === 'Enter' && clientId) loadKeys(clientId, pattern) }}
                ...
                <button
                  onClick={() => clientId && loadKeys(clientId, pattern)}
            ...
            {!selectedKey ? (
              ...
              <div className="flex flex-col h-full overflow-hidden">
                ...
                >
                  ...
                  <button onClick={() => { setSelectedKey(null); setKeyValue(null) }}>
...
function ValueViewer({ value }: { value: KeyValue }) {
